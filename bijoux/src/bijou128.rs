...
//! let mut buf = Vec::new();
//! bijoux::bijou128::encode(42, &mut buf);
//! assert_eq!(buf, [0x2A]);
//!
//! // First multi-byte value: tag 0xF0 plus 1 payload byte.
//! let mut buf = Vec::new();
//! bijoux::bijou128::encode(240, &mut buf);
//! assert_eq!(buf, [0xF0, 0x00]);
//!
//! // Round-trip through `decode`.
//! let mut buf = Vec::new();
//! bijoux::bijou128::encode(u128::MAX, &mut buf);
//! let (value, len) = bijoux::bijou128::decode(&buf).unwrap();
...
///
/// ```
/// assert_eq!(bijoux::bijou128::encoded_len(0), 1);
/// assert_eq!(bijoux::bijou128::encoded_len(239), 1);
/// assert_eq!(bijoux::bijou128::encoded_len(240), 2);
/// assert_eq!(bijoux::bijou128::encoded_len(495), 2);
/// assert_eq!(bijoux::bijou128::encoded_len(496), 3);
/// assert_eq!(bijoux::bijou128::encoded_len(u128::MAX), 17);
/// ```
#[inline]
#[must_use]
...
///
/// ```
/// use bijoux::bijou128::encoded_bytes;
///
...
///
/// ```
/// let enc = bijoux::bijou128::encoded_bytes(240);
...
/// ```
/// // Single-byte value
/// let (v, n) = bijoux::bijou128::decode(&[0x2A]).unwrap();
/// assert_eq!((v, n), (42, 1));
///
/// // Multi-byte value with trailing data
/// let (v, n) = bijoux::bijou128::decode(&[0xF0, 0x00, 0xFF]).unwrap();
/// assert_eq!((v, n), (240, 2));
/// ```
#[inline]
...
///
/// ```
/// use bijoux::bijou128::{decode_iter, encode};
///
/// let mut buf = Vec::new();
...
///
/// ```
/// use bijoux::bijou128::{decode_all, encode};
///
/// let mut buf = Vec::new();
