...
# ]
# ///
"""Analyze Criterion benchmark results for the bijou128 shootout.

Reads target/criterion/**/new/{sample,estimates}.json, computes percentile
statistics, and generates:

  - bijou128/charts/<arch>/percentiles.csv   (machine-readable summary)
  - bijou128/charts/<arch>/percentiles.md    (markdown table)
  - bijou128/charts/<arch>/*.svg             (static charts)
  - bijou128/charts/<arch>/*.html            (interactive Plotly charts)

Usage:
  uv run bijou128/charts/analyze.py --arch x86    # explicit architecture
  uv run bijou128/charts/analyze.py --arch arm    # explicit architecture
  python bijou128/charts/analyze.py               # auto-detects from `uname -m`
...
DIST_LABELS = {
    "tiny_0_239": "tiny",
    "small_240_65535": "small",
    "medium_64k_4G": "medium",
    "large_4G_to_u64max": "large (u64)",
    "xlarge_above_u64": "xlarge (u128)",
    "boundary": "boundary",
    "uniform_random": "uniform",
}

# Legacy names for backward compatibility with old Criterion data
DIST_ALIASES: dict[str, str] = {}
...
COLOURS = {
    "bijou128": "#16a34a",  # green (matches bijou64 across the family)
    "vu128": "#2563eb",  # blue
}
...
<head>
<meta charset="utf-8">
<title>bijou128 Shootout Percentiles</title>
...
<body>
<h1>bijou128 Shootout &mdash; Percentile Statistics</h1>
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Analyze Criterion benchmark results for the bijou128 shootout.",
    )
    parser.add_argument(
        "--arch",
        default=None,
    ...
    out_dir = workspace / "bijou128" / "charts" / arch
