...
/**
 * Cross-browser tests for the wasm-bodge-built `bijou128` npm package.
 *
 ...
 * exposes the module on `window.bijou128`, and sets `window.bijou128Ready`
...
export default defineConfig({
  ...
  webServer: {
    ...
    // Port 9893 to avoid colliding with bijou64_wasm (9892) and
    // subduction's e2e (9891) when multiple dev shells run at once.
    command: "http-server -p 9893 -s -c-1 .",
    port: 9893,
    timeout: 60 * 1000,
